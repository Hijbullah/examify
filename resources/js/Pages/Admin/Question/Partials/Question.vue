    ...
    <div>
        <div class="relative p-5 bg-white shadow-sm">
            ...
            <div v-if="examStatus === 'pending'" class="absolute right-0 top-0 mt-4 mr-3">
                <Link :href="route('admin.questions.edit', [examCode, question.id])" class="inline-flex items-center px-2 py-1 bg-gray-800 text-white text-xs font-bold tracking-widest uppercase rounded hover:bg-gray-600 focus:outline-none">
