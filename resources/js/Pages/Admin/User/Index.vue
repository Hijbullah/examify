<template>
    <admin-layout>
        <div>
            <h2 class="text-xl text-gray-900 font-semibold border-b-2 border-gray-900">All Admins</h2>
        ...
        watch: {
            form: {
                ...
                handler: _.throttle(function() {
                    this.$inertia.get(route('admin.users.index'), _.pickBy(this.form), { preserveState: true })
                }, 150),
            },
        },
        methods: {
